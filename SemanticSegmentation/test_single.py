...
parser.add_argument('--dataset_root', default='/home/pc/projs/zq/6dPose/wangzihang_new_20230622/MaskedFusion/datasets/ycb/YCB_Video_Dataset', help="dataset root dir (''YCB_Video Dataset'')")
...
parser.add_argument('--model_save_path', default='/home/pc/projs/zq/6dPose/wangzihang_new_20230622/MaskedFusion/SemanticSegmentation/trained_models/best_model_9_0.03870791043269243.pth', help="path to load models")
...
if __name__ == '__main__':
    img_path = 'data/0054/000932'
    # test_dataset = SegDataset(opt.dataset_root, '{0}/{1}'.format(opt.dataset_root, 'dataset_config/test_data_list.txt'), False, 1000)
    test_dataset = SegDataset(opt.dataset_root, '{0}/{1}'.format(opt.dataset_root, 'dataset_config/single.txt'), False, 1)
    ...
    rgb = np.array(Image.open('/home/pc/projs/zq/6dPose/wangzihang_new_20230622/MaskedFusion/datasets/ycb/YCB_Video_Dataset/data/0054/000932-color.png').convert("RGB"))
    label = np.array(Image.open('/home/pc/projs/zq/6dPose/wangzihang_new_20230622/MaskedFusion/datasets/ycb/YCB_Video_Dataset/data/0054/000932-label.png'))
    depth = np.array(Image.open('/home/pc/projs/zq/6dPose/wangzihang_new_20230622/MaskedFusion/datasets/ycb/YCB_Video_Dataset/data/0054/000932-depth.png'))
    meta = scio.loadmat('/home/pc/projs/zq/6dPose/wangzihang_new_20230622/MaskedFusion/datasets/ycb/YCB_Video_Dataset/data/0054/000932-meta.mat')
    ...
    orig_depth = copy.deepcopy(depth)
    ...
    rgb, target, depth = Variable(rgb).cuda(), Variable(target).cuda(), Variable(depth).cuda()
    ...
    orig_depth = orig_depth.detach().cpu().numpy()[0]
    orig_depth = Image.fromarray(orig_depth.astype('uint8'))
    orig_depth.save('{0}depth_{1}.png'.format(opt.img_path, j))
    #'''
    ...
    print("{0} - saved...".format(img_path[0]))
    input("...")
    print('Test Finish')
