...
from segnet_withoutCL import SegNet as segnet
import sys
sys.path.append("..")
...
parser.add_argument('--model_save_path', default='/home/pc/projs/zq/6dPose/wangzihang_new_20230622/MaskedFusion/SemanticSegmentation/AblationStudy/trained_models_withoutCM_202307132321_1stStepTrain/model_64_0.038625706425867976.pth', help="path to load models")
...
if __name__ == '__main__':
    test_dataset = SegDataset(opt.dataset_root, '{0}/{1}'.format(opt.dataset_root, 'dataset_config/test_data_list.txt'), False, 2949)
    ...
    for j, data in enumerate(test_dataloader, 0):
        ...
        img_path, orig, orig_depth, rgb, target, depth = data  # To test and see orig image
